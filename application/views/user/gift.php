		...
		<div class="col-md-3 col-sm-6 col-12">
			<div class="card shadow-sm m-2" style="min-height: 300px;">
				<div class="card-body text-center">
					...
					<a class="d-block" href="<?php echo base_url('user/single_gift/'.$key->p_id);?>" style="font-size:14px;"><?php echo $key->p_name; ?></a>
					...
					<form action=""  class="form-submit" method="post">
                     ...
                     <button  class="addToCartGift btn btn-cart text-uppercase" <?php if($key->status==0){echo 'disabled';} ?>><i class="fa fa-cart-plus" aria-hidden="true"></i> Add to Cart</button>
                     </form>
