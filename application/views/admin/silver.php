<div class="page-wrapper">
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Add Silver Category</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <?php endif;?>
                            <form class="form-horizontal"  action="<?php echo base_url('admin/add_silver');?>" method="post" enctype="multipart/form-data">
                                <div class="card-body">
