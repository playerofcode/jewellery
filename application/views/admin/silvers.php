...
<div class="page-wrapper">
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Add Silver Product</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <?php endif;?>
                            <form class="form-horizontal"  action="<?php echo base_url('admin/add_silvers');?>" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                 ...
                                 <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="p_unit" id="" class="form-control">
                                                ...
                                                <option value="mm" <?php echo  set_select('p_unit', 'mm'); ?>>mm</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="p_description" id="" cols="30" rows="10" class="form-control" style="resize: none;"><?php echo set_value('p_description'); ?></textarea>
