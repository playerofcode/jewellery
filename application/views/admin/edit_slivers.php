<div class="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <?php endif;?>
                            <form class="form-horizontal"  action="<?php echo base_url('admin/update_silvers');?>" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="p_description" id="" cols="30" rows="10" class="form-control" style="resize: none;"><?php echo set_value('p_description',$res->p_description); ?></textarea>
